...
- DuckDuckGo returns results and content
...
Websites can:
- receive your IP address and standard HTTP/HTTPS request data
- run scripts, load resources, and display content
- store cookies/site data depending on the web engine configuration
...
This is a safety feature, but it does not guarantee protection from all threats.
...
- popups/new windows are blocked
- navigation stays inside the main browser window

This is meant to reduce nuisance popups and confusing navigation paths.
...
- cookies and website data (managed by the embedded web engine)
- your User Agreement acceptance flag
...
**Important:** The App may be built using an older web component in some environments. The developer **cannot guarantee full security**.

You agree that you use the App **at your own risk**.

Safety recommendations:
- avoid entering passwords or payment details on unknown or untrusted websites
...
- understand that online content may be unsafe
...
- malware, phishing, scams, or unsafe content you may encounter online
- damages resulting from use of the App or the websites you visit
...
If the agreement changes significantly, the App may show an updated consent screen.
